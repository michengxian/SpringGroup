package com.mi.learn.springcloud.consumer8010.tool;
...
public class HttpUtils {
     ...
     * @return com.mi.learn.springcloud.base.bean.ResponseEntity 响应对象封装类
     */
     ...
     */
    public <T> ResponseEntity<T> get(String url, Class<UserInfoBean> responseType, RequestBean<Long> uriVariables)
            throws RestClientException {
        return (ResponseEntity<T>) restTemplate.getForEntity(url, responseType, uriVariables);
    }
